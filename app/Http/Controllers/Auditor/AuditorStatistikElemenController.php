...
class AuditorStatistikElemenController extends Controller
{
    public function index()
    {
        ...
        return view('pages.auditor.statistik-elemen.index', [
    ...
    public function chartElemen(Request $request, $periode, $prodi)
    {
        ...
        return view('pages.auditor.statistik-elemen.chart-elemen.index', [
