...
<nav class="page-breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="#">Pengguna Prodi</a></li>
    <li class="breadcrumb-item active" aria-current="page">Edit Pengguna Prodi</li>
  </ol>
</nav>
  ...
  <div class="col-lg-12 grid-margin stretch-card">
    <div class="card">
      <div class="card-body">
        ...
        <form action="{{ route('admin.pengguna-prodi.update', $users->id) }}" method="POST" enctype="multipart/form-data" id="PenggunaProdiFormEdit">
          @csrf
          @method('PUT')
          <div class="row">
            <div class="col-sm-6">
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="mb-3">
                ...
                <select class="form-select" name="user_penempatan" id="user_penempatan">
                  <option disabled {{ empty($users->user_penempatan) ? 'selected' : '' }}>-</option>
                  @foreach($ProgramStudis as $ProgramStudi)
                    <option value="{{ $ProgramStudi->prodi_jenjang .' - '. $ProgramStudi->prodi_nama }}"
                      {{ (old('user_penempatan', $users->user_penempatan) == $ProgramStudi->prodi_jenjang .' - '. $ProgramStudi->prodi_nama) ? 'selected' : '' }}>
            ...
            <div class="col-sm-6">
              <div class="mb-3">
                ...
                <input id="user_fakultas" class="form-control @error('user_fakultas') is-invalid @enderror" name="user_fakultas" type="text" value="{{ old('user_fakultas', $users->user_fakultas) }}" readonly>
                @error('user_fakultas')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
              </div>
          ...
          <input type="hidden" name="user_akses" id="user_akses" value="{{ old('user_akses', $users->user_akses) }}">
          <div class="row">
            <div class="col-sm-6">
                <div class="mb-3">
