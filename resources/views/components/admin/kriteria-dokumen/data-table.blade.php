<!-- resources/views/components/admin/kriteria-dokumen/data-table.blade.php -->
<div class="row">
    ...
    <div class="card">
      <div class="card-body">
        ...
        <div class="table-responsive">
          <table id="{{ $tableId }}" class="table-striped table-hover" style="font-size: 0.875rem;">
            <thead>
              <tr>
            ...
            <tbody>
              @foreach ($data as $standard)
                ...
                <x-admin.kriteria-dokumen.modal :id="'infoModal' . $standard->id" title="Informasi Penilaian">
                  @foreach (explode("\n", $standard->indikator_info) as $line)
                    {{ $line }}<br>
                  @endforeach
                </x-admin.kriteria-dokumen.modal>
              @endforeach
            </tbody>
          </table>
        </div>
