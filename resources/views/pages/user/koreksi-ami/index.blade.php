              ...
              <div class="card">
                <div class="card-body">
                  ...
                  <div class="row">
                    ...
                    <a href="{{ route('user.koreksi-ami.revisi-prodi', ['periode' => urlencode($kesiapan->periode), 'prodi' => $kesiapan->prodi]) }}" class="btn btn-secondary btn-icon-text mb-2 mb-md-0" title="Perbarui Data">
