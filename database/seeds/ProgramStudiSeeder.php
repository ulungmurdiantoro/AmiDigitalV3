...
class ProgramStudiSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $items = [
            ...
            ['program_studis_code' => 'PS-S1-TIF',  'prodi_nama' => 'Teknik Informatika',    'prodi_jenjang' => 'S1', 'prodi_jurusan' => 'Teknik Informatika',    'prodi_fakultas' => 'Fakultas Teknik',                            'prodi_akreditasi' => 'LAMINFOKOM'],
