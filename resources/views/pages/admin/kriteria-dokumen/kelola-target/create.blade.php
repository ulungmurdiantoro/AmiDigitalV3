          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="mb-3">
                ...
                <input id="dokumen_nama" class="form-control @error('dokumen_nama') is-invalid @enderror" name="dokumen_nama" type="text" value="{{ old('dokumen_nama') }}" placeholder="Nama Dokumen">
                @error('dokumen_nama')
            ...
            <div class="col-sm-6">
              <div class="mb-3">
                ...
                <input id="pertanyaan_nama" class="form-control @error('pertanyaan_nama') is-invalid @enderror" name="pertanyaan_nama" type="text" value="{{ old('pertanyaan_nama') }}" placeholder="Pertanyaan">
              ...
              <div class="mb-3">
                ...
                <select class="form-select" name="dokumen_tipe" id="dokumen_tipe" required>
                  ...
                  @foreach($dokumenTipes as $tipeDokumen)
                    <option value="{{ $tipeDokumen->tipe_nama }}">{{ $tipeDokumen->tipe_nama }}</option>
                  @endforeach
                </select>
                @error('dokumen_tipe')
                  <div class="invalid-feedback">{{ $message }}</div>
