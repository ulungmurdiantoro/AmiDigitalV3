...
<nav class="page-breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="#">Pengajuan Ami</a></li>
      ...
      <div class="card-body">
        ...
        <form action="{{ route('admin.kriteria-dokumen.storeImport') }}" method="POST" enctype="multipart/form-data" id="PenggunaAuditorForm">
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="mb-3">
                <label for="nama_dokumen" class="form-label">Tahun</label>
                <input name="nama_dokumen" type="text" class="form-control @error('nama_dokumen') is-invalid @enderror" disabled/>
                @error('nama_dokumen')
          ...
          <div class="row">
            <div class="col-sm-6">
              <div class="mb-3">
                <label for="nama_dokumen" class="form-label">Status</label>
                <input name="nama_dokumen" type="text" class="form-control @error('nama_dokumen') is-invalid @enderror" disabled/>
                @error('nama_dokumen')
                  <div class="invalid-feedback">{{ $message }}</div>
                @enderror
