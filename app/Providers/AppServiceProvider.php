...
class AppServiceProvider extends ServiceProvider
{
    ...
    protected function registerComponentBindings()
    {
        $bindings = [
            ...
            \App\View\Components\Auditor\DataTable\AuditAmi::class => ['id', 'standards', 'elements', 'transaksis', 'prodis', 'periodes', 'showImportData', 'importTitle'],
            ...
            \App\View\Components\Auditor\DataTable\RevisiAmi::class => ['id', 'standards', 'elements', 'transaksis', 'prodis', 'periodes', 'showImportData', 'importTitle'],
            ...
            \App\View\Components\DataTableRekapNilai::class => ['id', 'standards', 'elements', 'transaksis', 'prodis', 'periodes', 'showImportData', 'importTitle'],
